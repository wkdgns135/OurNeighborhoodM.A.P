			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">#음악</h1>
						<a href="showexample.html">더보기 &rarr;</a>
						...
						<div class="card shadow mb-4">
							...
							<div class="card-body">
								<div class="text-center">
									<form action="showview.jsp" method="get">
										<input type="hidden"
											value="<%out.print(rs.getString("video"));%>" name="video">
										<input type="hidden"
											value="<%out.print(rs.getString("title"));%>" name="title">
										<input type="hidden"
											value="<%out.print(rs.getString("content"));%>"
											name="content"> <input type="hidden"
											value="<%out.print(rs.getString("thumbnail"));%>"
											name="thumbnail"> <input type="hidden"
											value="<%out.print(rs.getInt("u_number"));%>"
											name="number"> <input type="submit" value=""
											class="img-fluid px-3 px-sm-4 mt-3 mb-4"
											style="background: url(temp/<%out.print(rs.getString("thumbnail"));%>);
									width: 25rem; height: 15rem; border: 0; background-repeat : no-repeat; background-size : 25rem 15rem;
					...
					<div
						class="d-sm-flex align-items-center justify-content-between mb-4">
						<h1 class="h3 mb-0 text-gray-800">#미술</h1>
						<a href="showexample.html">더보기 &rarr;</a>
					...
					<div
						class="d-sm-flex align-items-center justify-content-between mb-4">
						<h1 class="h3 mb-0 text-gray-800">#체육</h1>
						<a href="showexample.html">더보기 &rarr;</a>
					...
					<div
						class="d-sm-flex align-items-center justify-content-between mb-4">
						<h1 class="h3 mb-0 text-gray-800">#자연</h1>
						<a target="_blank" rel="nofollow" href="https://undraw.co/">더보기
							&rarr;</a>
