	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item active"><a class="nav-link"
				href="index.jsp"> <i></i> <span>홈</span></a></li>
			...
			<!-- Nav Item - Charts -->
			<li class="nav-item"><a class="nav-link" href="upload.jsp">
					<span>새영상업로드</span>
			</a></li>
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<!-- Begin Page Content -->
				<%
				String content,title,video, thumbnail;
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<center>
						<h1 id="view_title" class="padding_bottom h3 mb-2 text-gray-800"><%out.print(title);%></h1>
					</center>
					<center class="padding_bottom">
						<div
							style="width: 80%; height: 500px; left: 0px; top: 0px; background-color: #000000">
							<video style="margin: 20px auto; width: 100%; height: 90%;"
								controls poster="temp/<%out.print(thumbnail);%>">
								<source src="temp/<%out.print(video);%>" type="video/mp4">
								<strong>Your browser does not support the video tag.</strong>
							</video>
							<!--<img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 100%; height: 90%;" src="img/sample3.jpg" alt="...">-->
						</div>
						<!-- Content Row -->
						<div
							style="display: flex; width: 80%; height: 50px; background-color: #FFFFFF; justify-content: space-between; align-items: center; overflow: hidden;">
							<div
								style="display: flex; justify-content: center; align-items: center;">
								<img
									src="http://t1.daumcdn.net/friends/prod/editor/dc8b3d02-a15a-4afa-a88b-989cf2a50476.jpg"
									alt="My Image" width="70" height="50">
								<p id="view_writer"
									style="padding-top: 20px; display: flex; font-style: bold;">라이언은
									귀여워님</p>
							</div>
							<div
								style="display: flex; justify-content: center; align-items: center; padding-right: 2%">
								<img id="love_button"
									src="https://i1.sndcdn.com/avatars-000647820000-bz8qap-t500x500.png"
									alt="My Image" width="50" height="50">
								<p id="view_love"
									style="padding-top: 20px; display: flex; font-style: bold;">255</p>
							</div>
						</div>
						<hr class="three">
						<div
							style="display: flex; width: 80%; height: 50px; background-color: #FFFFFF; overflow: auto;">
							<p id="view_text"
								style="padding-top: 15px; padding-left: 2%; display: flex; font-style: bold;">
								<% 
								out.println(content);
								%>
								</p>
						...
						<div
							style="display: flex; width: 80%; height: 50px; overflow: auto; justify-content: flex-end;">
							<div
								style="display: flex; justify-content: center; align-items: center;">
								<p style="padding-top: 20px; padding-right: 10px;">영상에 대한
									전문가의 반응이 궁금하다면</p>
								<input type='button' value='피드백 확인하기' />
							</div>
						</div>
					</center>

					<center class="padding_bottom">
						<div id="form-commentInfo" style="padding-top: 50px">
							<div id="comment-count" align="left"
								style="padding-left: 10%; padding-bottom: 10px;">
								댓글 <span id="count">2</span>
							</div>
							<div id="comment_text">
								<div
									style="display: flex; width: 80%; height: auto; background-color: #FFFFFF; overflow: auto;">
									<img id="comment_img"
										src="http://upload.inven.co.kr/upload/2014/12/14/bbs/i4433556595.jpg"
										alt="My Image" width="70" height="50">
									<div style="padding-top: 10px;">
										<p id="comment_writer"
											style="display: flex; font-style: bold;">고양이가 최고야님</p>
										<p id="comment_text">너무 잘 하시네요 잘 보고 갑니다!</p>
									</div>
								</div>
							</div>
							<hr class="three">
							<div id="comment_text">
								<div
									style="display: flex; width: 80%; height: auto; background-color: #FFFFFF; overflow: auto;">
									<img id="comment_img"
										src="https://en.pimg.jp/071/758/170/1/71758170.jpg"
										alt="My Image" width="70" height="50">
									<div style="padding-top: 10px;">
										<p id="comment_writer"
											style="display: flex; font-style: bold;">강아지가 최고야님</p>
										<p id="comment_text">저도 한번 해봐야겠어요 추천 꾹~</p>
									</div>
								</div>
							</div>
							<div id="input-text" align="center" style="padding-top: 20px;">
								<input style="width: 70%;" id="comment-input"
									placeholder="댓글을 입력해 주세요.">
								<button style="width: 10%;" id="submit">등록</button>
							</div>
						</div>
					</center>
				</div>
